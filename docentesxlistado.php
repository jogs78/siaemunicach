        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Listado de Docentes <span class="semi-bold"></span></h4>
                ...
                <table class="table table-hover table-condensed" id="example">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="width:40%">Apellidos</th>
                  ...
                  <tbody>
                    ...
                    for($i=0; $i<$listado; $i++){						
                        ...
                        echo "<td align='center'><span>".$datos[$i]['idusuario']."</span></td>";
