  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Registro de Planes de Estudio</a> </li>
      </ul>
            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Registrar Plan de Estudio<span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="pestudioxrxg.php" method="post">

                      <div class="form-group">
                        <label class="form-label">Nombre  del Plan de Estudio</label>
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input type="text" name="nplan" id="nplan" value="" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="number" name="anio" id="anio" value="" class="form-control" required>
                        </div>
                      </div>
