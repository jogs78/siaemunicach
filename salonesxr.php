            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Registrar Ingreso <span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="salonesxrxg.php" method="post">

                      <div class="form-group">
                        <label class="form-label">Salón *</label>
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input type="text" name="salon" id="salon" value="" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="number" name="cupo" id="cupo" value="" class="form-control" required>
                        </div>
                      </div>
