            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Inscripción <span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="inscripcionxg.php" method="post">                      
					<input id="idgrupo" name="idgrupo" type="hidden" value="<?php echo $idg ?>">
				  <div class="form-actions">  
					<div class="pull-right">
					  <button type="submit" class="btn btn-success btn-cons"><i class="icon-ok"></i> Inscribirme a este curso</button>
					  <a href="principal.php"><button type="button" class="btn btn-white btn-cons">Regresar</button></a>
					</div>
					</div>
				</form>
                </div>
