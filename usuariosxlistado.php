  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Listado de Usuario</a> </li>
      </ul>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Listado de Usuarios <span class="semi-bold"></span></h4>
                ...
                <table class="table table-hover table-condensed" id="example">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="width:29%" data-hide="phone,tablet">Tipo de Usuario</th>
                  ...
                  <tbody>
                    ...
                    for($i=0; $i<$listado; $i++){						
                        ...
                        echo "<td align='center'><span>".$datos[$i]['grupo']."</span></td>";
                        echo "<td align='center'>
							<a href='usuariosxpermisos.php?k=$idu' title='Detalle'><i class='fa fa-list-alt'></i></a>
							</td>";
                        echo "</tr>";
                        }
                    ?>
