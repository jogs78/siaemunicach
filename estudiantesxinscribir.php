...
$obj = new Usuario();
$idusuario = $obj->getIdUsuario($k);

$datos = $obj->getUsuarioDetalle01($idusuario);
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Estudiantes Inscribir</a> </li>
      </ul>
            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Registrar pago de estudiantes<span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="inscribirxg.php" method="post">
                <input type="hidden" id="idusuario" name="idusuario" value="<?php echo $idusuario; ?>">
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input type="text" value="<?php echo $datos[0]['nombre'].' '.$datos[0]['apellidos']; ?>" class="form-control" required>
                        </div>
                      </div>
