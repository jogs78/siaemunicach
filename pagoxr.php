...
$obj = new Escuela();
$idpago = $obj->getIdPago($k);

$datos = $obj->getDetallePago($idpago);
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Registrar Pago<span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="pagoxrxg.php" method="post">
                <input type="hidden" id="idpago" name="idpago" value="<?php echo $idpago; ?>">
                <input type="hidden" id="idusuario" name="idusuario" value="<?php echo $datos[0]['fkusuario']; ?>">

                      <div class="form-group">
                        <label class="form-label">Estudiante </label>
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input type="text" value="<?php echo $datos[0]['alumno'].' '.$datos[0]['concepto']; ?>" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="text" name="nref" id="nref" value="" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="text" name="cantidad" id="cantidad" value="0.00" class="form-control" required>
                        </div>
                      </div>
