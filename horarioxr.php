...
$objG = new Grupo();
$idgrupo = $objG->getIdGrupo($k);
$idpestudio = $objG->getGrupoIdPlanDeEstudio($idgrupo);

$objM = new Materia();
$materias = $objM->getListadoMateriasxPlan($idpestudio);
$longitudM = count($materias);

$objU = new Usuario();
$docentes = $objU->getListadoUsuariosDoc();
$longitudD = count($docentes);

$listadomat = $escuela->getHorariosListadoMateriasXGrupo($idgrupo);
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#">Horarios de Clases</a> </li>
        <li><a href="#" class="active">Registrar</a> </li>
      </ul>
            ...
            <div class="col-md-12">
              <div class="grid simple">
                <div class="grid-title no-border">
                  <h4>Registrar <span class="semi-bold"></span></h4>
                  <div class="tools"> <a href="javascript:;" class="collapse"></a> <a href="#grid-config" data-toggle="modal" class="config"></a> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                </div>
                <div class="grid-body no-border">
				<form id="form" action="horarioxrxg.php" method="post">
	                <input id="idgrupo" name="idgrupo" type="hidden" value="<?php echo $idgrupo ?>">	
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
                            <select style="width:100%" name="fkmateria" required>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
                            <select style="width:100%" name="fkdocente" required>
                                <option value="" selected>Elegir...</option>                               
                                <?php                        
                                for($i=0; $i<$longitudD; $i++){						
                                    echo "<option value='".$docentes[$i]['idusuario']."'>".
                                    $docentes[$i]['nombre'].' '.$docentes[$i]['apellidos']."</option>";
                                    }
                                ?>
                            </select>
						</div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
                            <select style="width:100%" name="dia" required>
                                <option value="" selected>Elegir...</option>                                        
                                <?php                        
                                for($i=0; $i<$ndias; $i++){						
                                    echo "<option value='".$dias[$i]['iddia']."'>".
                                    $dias[$i]['dia']."</option>";
                                    }
                                ?>
                            </select>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="time" name="hinicio" value="" class="form-control" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
						...
						<div class="input-with-icon  right">                                       
							<i class=""></i>
							<input class="span6" type="time" name="hfin" value="" class="form-control" required>
                        </div>
                      </div>
				  ...
				  <div class="form-actions">  
					<div class="pull-right">
					  ...
					  <a href="gruposxlistadoxh.php"><button type="button" class="btn btn-white btn-cons">Regresar</button></a>
					</div>
					</div>
				</form>
                </div>
